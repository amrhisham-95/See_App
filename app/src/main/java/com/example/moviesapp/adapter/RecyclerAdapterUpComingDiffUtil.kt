...
class RecyclerAdapterUpComingDiffUtil(private val onRecyclerViewClickUpComingMovie: OnRecyclerViewClickUpComingMovie) :
    PagingDataAdapter<DetailsOfUpComing, RecyclerAdapterUpComingDiffUtil.MyViewHolder>(
        differCallback
    ){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.binding.apply {
            ...
            customRecycler2.setOnClickListener {
                onRecyclerViewClickUpComingMovie.onClickedUpComing(position)
            }
        }
    }
...
companion object{
    ...
    private val differCallback = object : DiffUtil.ItemCallback<DetailsOfUpComing>() {
        override fun areItemsTheSame(
            oldItem: DetailsOfUpComing,
            newItem: DetailsOfUpComing
        ): Boolean {
    ...
    fun currentSelected(pos:Int):DetailsOfUpComing?{
        return getItem(pos)
    }
}